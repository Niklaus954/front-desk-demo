import {lightningChart, AutoCursorModes, emptyFill, emptyLine,
    AxisTickStrategies, AxisScrollStrategies, synchronizeAxisIntervals,
    UIOrigins, UIDraggingModes, LegendBoxBuilders, Themes,} from "@arction/lcjs";
import React, {useEffect, useId, useRef, useState} from "react";
import {createProgressiveTraceGenerator, createSampledDataGenerator} from "@arction/xydata";
    ...
    useEffect(() => {
        ...
        const chart = lightningChart({
            ...
            .ChartXY({
                ...
                container:exampleContainer as HTMLDivElement
            })
            // .Dashboard({
            //     numberOfColumns: 2,
...
const ExampleContainer: React.FC = () => {
    ...
    return (
        <IonPage>
            <IonHeader>
                <IonToolbar>
                    <IonTitle>LightningChart测试</IonTitle>
                </IonToolbar>
            </IonHeader>
            <IonContent fullscreen id='chart' >
                <Chart />
            </IonContent>
        </IonPage>
    );
